  ...
  return (
   <>
    ...
    <div className="container">
      <div className="row justify-content-evenly">
        <div className="col-4 my-3">
          ...
          <h3 className="top">We are the creaters...</h3>
        </div>
        <div className="col-4 my-3">
    ...
    <div className="container">
              ...
              <h2 className="card-title-text">You do business we do the software</h2> 
            <div className="row align-items-start">
            <div className="col">
            <div className="card">
                <div className="card-body">
                  <div className="card-title">
                  <Icon icon="uil:chart-growth" color="#98ebfe" width="60" />
                  </div>
                  <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <div className="card-end">
                    <a className="card-end-text" href="/">Learn more</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card">
                <div className="card-body">
                  <div className="card-title">
                  <Icon icon="carbon:download-study" color="#98ebfe" width="60" />
                  </div>
                  <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <div className="card-end">
                    <a className="card-end-text" href="/">Learn more</a>
            ...
            <div className="card">
                <div className="card-body">
                  <div className="card-title">
                  <Icon icon="fluent:code-circle-20-filled" color="#98ebfe" width="60" />
                  </div>
                  <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <div className="card-end">
                    <a className="card-end-text" href="/">Learn more</a>
